...
>> Esse arquivo é um report; devia estar em `reports/`
...
Ao observar os gráficos acima, pode-se extrair algumas informações que serão valiosas para responder a pergunta desta seção. Primeiramente, a série Stranger Things não possui tantos episódios quanto as outras, o que pode levar a resultados com pouca significância estatística.
...
>> Difícil ver a média. Talvez fosse uma boa plotá-la / calculá-la?
...
>> Legal a observação antes desse comentário. Que tal quantificá-la?
...
>> Seria uma boa quantificar o alongamento do boxplot com o IQR: vikings é maior ou menor que ST?
...
>> No fundo, a medida quantifica uma impressão visual que você teve, mais do que validá-la ou não. 
